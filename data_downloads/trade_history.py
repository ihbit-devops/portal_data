...
header = 'uid,tradeId,orderId,symbol,price,qty,quoteQty,commission,commissionAsset,tradeDirection,createTime,updateTime'
...
with open('./jan.csv', 'a') as the_file:
    the_file.write('{}\n'.format(header))
    
    for _ in range(0, 1000000, 500):
        url = "https://www.x-meta.com/bc/v1/exchange/trade-records?startTime=1672502400000&endTime=1674489599000&settleStatus=10&offset={}&limit=500".format(_)
